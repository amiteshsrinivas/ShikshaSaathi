...
import { Menu, Users, HelpCircle, LineChart, MessageCircle, Settings, LogOut, Sun, Moon } from "lucide-react";
        ...
        <Sidebar className="w-[280px]">
          <SidebarHeader>
            <div className="flex items-center px-4 py-3">
              ...
              <span className="text-edu-blue font-bold text-xl">Teacher Portal</span>
